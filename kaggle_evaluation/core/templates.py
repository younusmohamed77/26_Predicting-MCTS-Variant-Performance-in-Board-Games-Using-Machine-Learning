...
class Gateway(kaggle_evaluation.core.base_gateway.BaseGateway, abc.ABC):
    ...
    def get_all_predictions(self):
        # TODO: complete this.
        # Should return all user submission data as either a Polars or Pandas dataframe
        raise NotImplementedError
        # TODO: validate_prediction_batch MUST be called every time you receive a prediction.
        # self.validate_prediction_batch(prediction_batch, sample_submission_batch)
